            ...
            <div class="print-body {$printType}">
                <div class="body-left row m-0">
                    ...
                    <div class="body-left-middle col px-0">
                        ...
                        | //tei:metamark[contains (@function, 'printSpan') and (contains(@rend, 'lineLeft') or contains(@rend, 'doubleLineLeft'))]
                ...
                <div class="body-right row m-0">
                    ...
                    <div class="body-right-middle col px-0">
                        ...
                        | //tei:metamark[contains(@function, 'printSpan') and (contains(@rend, 'lineRight') or contains(@rend, 'doubleLineRight'))]

// Shared helpers for the scripts/generate-*.mjs family: logo/cover-page
// rendering, date stamps and PDF merging. Kept dependency-free of any single
// script's page-capture logic so it can be reused by generators with very
...
export const RUN_DATE_ISO = new Date().toISOString().slice(0, 10);
...
export const LOGO_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 123.47 106.97" width="100" aria-hidden="true" focusable="false">

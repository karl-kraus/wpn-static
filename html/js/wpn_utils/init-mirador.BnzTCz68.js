var _a;
const manifestId = (_a = document.getElementById("mirador")) == null ? void 0 : _a.getAttribute("data-manifest");
if (manifestId) {
  ...
  Mirador.viewer({
    ...
    "workspaceControlPanel": {
      "enabled": false
      // Configure if the control panel should be rendered.  Useful if you want to lock the viewer down to only the configured manifests
    },
    "galleryView": {
      height: null,
      width: 50

...
test("register entries match", async ({ page }) => {
	...
	/*
	await page.goto(
		`https://kraus1933.ace.oeaw.ac.at/Gesamt.xml?template=register_personen.html&letter=${letter}`,
	);
	...
	await page.goto("http://localhost:8000/html/register_personen.html");
	...
	const fileStream = createReadStream(`tests/data/person_list_view/person_list_view_${letter}.txt`);

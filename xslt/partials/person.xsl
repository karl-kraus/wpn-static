    ...
    <xsl:template match="tei:person" mode="detail_view">
      <!--<xsl:result-document href="{@xml:id||'.html'}" method="html">-->
        <div class="d-none p-1 ps-0 pt-0 overflow-visible ls-2" id="{'details_'||@xml:id}">   
            <div class="person_signet_background my-0 mw-100 top-18 px-2 ps-3 pt-2 bg-position-detail-view bg-size-detail-view bg-no-repeat">
...
<!--</xsl:result-document>-->
    ...
    <xsl:template match="tei:person" mode="detail_view_textpage">
        ...
        id="{$elem_id}">
            <div class="person_signet_background my-0 mw-100 top-18 px-2 ps-2 pt-1 bg-position-detail-view bg-size-detail-view bg-no-repeat">
                <div class="border-0">

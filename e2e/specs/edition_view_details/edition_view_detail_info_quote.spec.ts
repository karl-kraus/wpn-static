...
import type { TestDataObjectIntertext } from "../../src/interfaces.js";
...
for (const pathToTest of pathsToTest) {
	const testData: Array<TestDataObjectIntertext> = await fetchTestData(`quote_detail_view_${pathToTest.path}.json`);
